...
const brokenBosonCatalog = [
  ...
  },
  {
    ...
    freeLagrangian: String.raw`\mathcal{L}_0=\left(D_\mu${C.S("\\Phi")}\right)^\dagger\left(D^\mu${C.S("\\Phi")}\right)-\mu^2${C.S("\\Phi")}^\dagger${C.S("\\Phi")}-\lambda\left(${C.S("\\Phi")}^\dagger${C.S("\\Phi")})^2`,
